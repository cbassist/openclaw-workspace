...
| [03-agent-runtime.md](03-agent-runtime.md) | Agent Runtime | Pi Embedded Runner, execution lifecycle, auth rotation, context compaction, subagents, **model configuration**. | You're debugging agent execution, failover, context window issues, **or configuring which models your agent uses**. |
...
| [09-model-operations.md](09-model-operations.md) | Model Operations | Provider tiers, fallback chain, subagent routing, cron models, cost optimization. | You need to change which models Shizzle uses or understand the model stack. |
